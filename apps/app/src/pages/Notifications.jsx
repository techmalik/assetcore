...
const KIND_META = {
  ...
  pm_assigned:   { label:'Maintenance', dot:'var(--sl)', bg:'var(--slb)', c:'var(--slt)' },
  pm_due:        { label:'Maintenance', dot:'var(--sa)', bg:'var(--sab)', c:'var(--sat)' },
  pm_overdue:    { label:'Maintenance', dot:'var(--sr)', bg:'var(--srb)', c:'var(--srt)' },
  inspection_assigned:{ label:'Inspection', dot:'var(--sl)', bg:'var(--slb)', c:'var(--slt)' },
  ...
  work_completed:{ label:'Completed',   dot:'var(--sg)', bg:'var(--sgb)', c:'var(--sgt)' },
  report_uploaded:{ label:'Report',     dot:'var(--sl)', bg:'var(--slb)', c:'var(--slt)' },
...
const PREF_KINDS = [
  ...
  { key:'pm_assigned',    label:'PM task assignments',    desc:'When a maintenance task is assigned to you' },
  { key:'inspection_assigned', label:'Inspection assignments', desc:'When an inspection is assigned to you' },
  ...
  { key:'work_completed', label:'Work completed',         desc:'A work order, task, or inspection you assigned is done' },
  { key:'report_uploaded',label:'Report uploads',         desc:'A completion report was uploaded' },
