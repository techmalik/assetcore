  ...
  return (
    <div style={{fontFamily:"'IBM Plex Sans',system-ui,sans-serif",color:'#0d1420',lineHeight:1.6,fontSize:15,background:'#fff'}}>
            ...
            <div>
              ...
              <div style={{display:'flex',alignItems:'center',gap:20}}>
                {[
                  ...
                  {icon:<svg width="13" height="13" viewBox="0 0 14 14" fill="none"><rect x="2" y="4" width="10" height="8" rx="1" stroke="rgba(255,255,255,.4)" strokeWidth="1.1"/><path d="M5 4V3a2 2 0 014 0v1" stroke="rgba(255,255,255,.4)" strokeWidth="1.1"/></svg>,label:'ISO 27001 hosting'},
                  ...
                  <div style={{display:'grid',gridTemplateColumns:'1fr 200px',gap:8}}>
                    <div style={{background:'#fff',borderRadius:4,border:'1px solid #e5e8ed',overflow:'hidden'}}>
                      <div style={{background:'oklch(95% .015 160)',height:120,position:'relative'}}>
                        <div style={{position:'absolute',inset:0,backgroundImage:'linear-gradient(rgba(0,0,0,.05) 1px,transparent 1px),linear-gradient(90deg,rgba(0,0,0,.05) 1px,transparent 1px)',backgroundSize:'20px 20px'}}/>
                    ...
                    <div style={{background:'#fff',borderRadius:4,border:'1px solid #e5e8ed',overflow:'hidden'}}>
                      ...
                      {[
                        ...
                        {title:'Licence expiring — LIC-0014',sub:'7 days · DPR · North',c:'oklch(68% .182 72)'},
                      ].map((a,i) => (
      ...
      <div style={{borderBottom:'1px solid var(--n200)',background:'var(--n50)'}}>
        <div style={{maxWidth:1200,margin:'0 auto',padding:'24px 40px',display:'flex',alignItems:'center',gap:32}}>
          <span style={{fontSize:12,fontWeight:600,color:'var(--n400)',letterSpacing:'.06em',textTransform:'uppercase',whiteSpace:'nowrap',flexShrink:0}}>Trusted by Nigerian gas operators</span>
          <div style={{height:1,background:'var(--n200)',flex:1}}/>
          <div style={{display:'flex',alignItems:'center',gap:28,flexWrap:'wrap'}}>
            {[
              {abbr:'NGML',bg:'var(--b800)',tc:'var(--b200)',name:'NGML'},
              {abbr:'TOTAL',bg:'#c8102e',tc:'#fff',name:'TotalEnergies Nigeria'},
              {abbr:'SHELL',bg:'#dd1d21',tc:'#fff',name:'Shell Nigeria'},
              {abbr:'SEPL',bg:'#003087',tc:'#fff',name:'Seplat Energy'},
            ].map(o => (
              <div key={o.abbr} style={{display:'flex',alignItems:'center',gap:7}}>
                <div style={{minWidth:36,height:20,background:o.bg,borderRadius:3,display:'flex',alignItems:'center',justifyContent:'center',padding:'0 4px'}}>
                  <span style={{fontFamily:'var(--ff-m)',fontSize:8,fontWeight:700,color:o.tc,whiteSpace:'nowrap'}}>{o.abbr}</span>
                </div>
                <span style={{fontSize:13,fontWeight:600,color:'var(--n600)'}}>{o.name}</span>
              </div>
            ))}
          </div>
        </div>
            ...
            <div>
              ...
              <div style={{display:'flex',flexDirection:'column',gap:10}}>
                {[
                  ...
                  'DPR audit requests trigger emergency scrambles to reconstruct records',
                ].map(t => (
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:1,background:'var(--n200)',border:'1px solid var(--n200)',borderRadius:8,overflow:'hidden',marginBottom:80}}>
            {[
              ...
              <div key={f.title} style={{background:'#fff',padding:28}}>
                <div style={{width:40,height:40,background:f.bg,border:`1px solid ${f.br}`,borderRadius:6,display:'flex',alignItems:'center',justifyContent:'center',marginBottom:16}}>{f.icon}</div>
        ...
        <div style={{maxWidth:1200,margin:'0 auto',padding:'0 40px'}}>
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr 1fr',gap:32,alignItems:'start'}}>
            ...
            {[
              ...
              ['ISO 27001 certified hosting','NDPR data residency options','Role-based access control','99.9% uptime SLA'],
            ].map((col,ci) => (
          ...
          <div style={{maxWidth:700,margin:'0 auto'}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:0,border:'1px solid var(--n200)',borderRadius:8,overflow:'hidden',background:'#fff'}}>
              {[
                ...
                {q:'Which Nigerian regulatory authorities are pre-configured?',a:'DPR (now NUPRC), NMDPRA, NESREA, FRSC, and SON come pre-loaded. You can add any custom authority your operation requires.'},
        ...
        <div style={{maxWidth:1200,margin:'0 auto',padding:'0 40px'}}>
          <div style={{display:'grid',gridTemplateColumns:'2fr 1fr 1fr 1fr',gap:48,marginBottom:48}}>
            <div>
              ...
              <p style={{fontSize:13,color:'rgba(255,255,255,.4)',lineHeight:1.7,maxWidth:280}}>Infrastructure asset management SaaS for oil &amp; gas distribution operators. Trusted by NGML and leading Nigerian energy companies.</p>
              <div style={{marginTop:16,fontFamily:'var(--ff-m)',fontSize:11,color:'rgba(255,255,255,.2)'}}>Lagos · Abuja · Port Harcourt</div>
            </div>
            {[
              {title:'Product',links:['Features','Pricing','Changelog','Roadmap']},
              {title:'Resources',links:['Documentation','DPR compliance guide','API reference','Support']},
