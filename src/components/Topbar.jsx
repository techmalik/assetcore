    ...
    <header style={{background:'var(--n0)',borderBottom:'var(--bdr)',flexShrink:0,zIndex:40}}>
      <div style={{height:52,display:'flex',alignItems:'center',padding:'0 24px',gap:16}}>
        <nav style={{display:'flex',alignItems:'center',gap:4,fontSize:13,flex:1}}>
          <span style={{color:'var(--n400)'}}>NGML</span>
        ...
        <div style={{display:'flex',alignItems:'center',gap:6}}>
          <div style={{position:'relative'}}>
            ...
            <span style={{position:'absolute',top:-3,right:-3,width:16,height:16,background:'var(--sr)',color:'#fff',fontSize:9,fontWeight:700,borderRadius:'50%',display:'flex',alignItems:'center',justifyContent:'center',border:'2px solid var(--n0)'}}>5</span>
          </div>
          ...
          <div style={{width:32,height:32,borderRadius:'50%',background:'var(--b700)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:11,fontWeight:600,color:'#fff',cursor:'pointer'}}>AO</div>
        </div>
      </div>
      {children}
    </header>
